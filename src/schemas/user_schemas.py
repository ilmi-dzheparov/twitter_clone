"""
Pydantic schemas for the User block
"""
...
class UserProfile(BaseModel):
    ...
    id: int = Field(..., description="Unique ID of the user")
    name: str = Field(..., description="Name of the user")
    followers: List[UserPreview] = Field(
        ..., description="List of users who follow this user"
    )
    following: List[UserPreview] = Field(
...
class UserProfileResponse(BaseModel):
    ...
    result: Literal[True] = Field(
        ..., description="Always True if the profile was retrieved successfully"
    )
...
class UserPostFollow(BaseModel):
    ...
    result: Literal[True] = Field(
        ..., description="True if the follow action was successful"
    )
...
class UserDeleteFollow(BaseModel):
    ...
    result: Literal[True] = Field(
        ..., description="True if the unfollow action was successful"
    )
